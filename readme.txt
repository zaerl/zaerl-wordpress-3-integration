...
Wordpress 3 deep integration fix. This plugin is no longer actively developed and is saved for historical reasons.

== Description ==

This plugin fix a problem that occurs during user registration when bbPress is deep integrated with WordPress 3.
